...
describe('Merkur Client', function() {
  ...
  describe('Connection is active', function() {
    ...
    describe('font can be resized', function() {
      ...
      it('should make the font of the log messages smaller when clicking on the smaller button', function() {
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('14px');
        element('#font-smaller').click();
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('13px');
        element('#font-smaller').click();
        element('#font-smaller').click();
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('11px');
      });

      it('should make the font of the log messages smaller only 5 times when clicking on the smaller button', function() {
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('14px');
        element('#font-smaller').click();
        element('#font-smaller').click();
        element('#font-smaller').click();
        ...
        element('#font-smaller').click();
        element('#font-smaller').click();
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('9px');
      });

      it('should make the font of the log messages bigger when clicking on the bigger button', function() {
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('14px');
        element('#font-bigger').click();
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('15px');
        element('#font-bigger').click();
        element('#font-bigger').click();
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('17px');
      });

      it('should make the font of the log messages bigger only 5 times when clicking on the bigger button', function() {
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('14px');
        element('#font-bigger').click();
        element('#font-bigger').click();
        element('#font-bigger').click();
        ...
        element('#font-bigger').click();
        element('#font-bigger').click();
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('19px');
      });

      it('should reset the font of the log messages to 14px when clicking on the default button', function() {
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('14px');
        element('#font-bigger').click();
        element('#font-bigger').click();
        element('#font-default').click();
        expect(element('.logmessages','Log messages container').css('font-size')).toBe('14px');
      });
